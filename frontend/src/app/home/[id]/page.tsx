          ...
          <div className='grid gap-3 items-start'>
            ...
            <div className='grid gap-4 text-sm leading-loose md:hidden'>
              <p>
                ...
                with high-quality materials and featuring a sleek, modern
                design, these sunglasses offer both fashion and function.
              </p>
              <p>
                Protect your eyes from harmful UV rays while looking
                effortlessly chic. Whether you\'re running errands or enjoying a
                day in the sun, these sunglasses will become your go-to
                accessory.
              </p>
            </div>
                ...
                <div className='grid gap-4'>
                  ...
                  <div className='grid gap-4 text-sm leading-loose'>
                    ...
                    <p>
                      ...
                      enjoying a day in the sun, these sunglasses will become
